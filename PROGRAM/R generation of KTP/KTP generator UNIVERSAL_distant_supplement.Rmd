...
output:
  word_document:
      reference_docx: ktp_templ_distant.docx
---
...
**УТВЕРЖДЕНО**      
Заведующий отделом    _________________     
___________________ /  _____________   /     
«____» ___________ `r Year_begin`       

\
\

**ПРИЛОЖЕНИЕ к КАЛЕНДАРНО-ТЕМАТИЧЕСКОМУ ПЛАНУ**    
...
c `r begin_distant` по `r end_distant`
...
kable(ktp_print, col.names = c("№", "Название раздела, темы", "Всего",	"Теория", "Практика","Дата занятия", "Ресурсы/Ссылки",	"Формы учебного материала", "Формы контроля"), align = "llccccc", row.names = FALSE)
```
